...
const LOOP = 15.0; // Standard loop matching 15s duration (450 frames @ 30fps)
...
export const SunsetDunes: React.FC = () => {
  ...
  // Frame-locked render driver
  useEffect(() => {
    if (!rendererRef.current || !sceneRef.current || !cameraRef.current || !uniformsRef.current) return;

    // Deterministic progression of time mapped to the 15-second loop
