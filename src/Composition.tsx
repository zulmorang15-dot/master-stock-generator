...
const MonoInk: React.FC = () => {
  ...
  // Loop duration matching video loop duration perfectly
  ...
  useEffect(() => {
    ...
    // Symmetrical elapsed loop mapping
    const elapsedTime = (frame / fps) % LOOP_DURATION;
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={labelStyle}>05 · Mono Ink</div>
    </div>
  );
};
